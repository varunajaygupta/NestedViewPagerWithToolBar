package com.example.forum.nestedfragments;
...
import com.example.forum.nestedfragments.adapter.ViewPagerAdapter;
...
public class ParentFragment extends Fragment{
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment("Tab1", Tab1.newInstance("", ""));
        viewPagerAdapter.addFragment("Tab2", Tab2.newInstance("", ""));
